...
public class MainApp extends JFrame{
    ...
    public static void main(String[] args){
        ...
        c.printVariables();
        System.out.println(c.getFormattedMethodContents(5));
        System.out.println(c.getVariablesUsedByMethod(5));
        System.out.println(c.getFormattedVariableName(2));
        System.out.println(c.getMethodsThatUseVariable(2));
    }
}
